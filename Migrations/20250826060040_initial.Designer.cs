...
namespace BusServices.Migrations
{
    ...
    [Migration("20250826060040_initial")]
            ...
            modelBuilder.Entity("BusServices.Models.BusImage", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            Caption = "Front View - Volvo Express",
                            EventId = 3,
            ...
            modelBuilder.Entity("BusServices.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ToPlace = "Bangalore",
                            TotalSeats = 40,
                            TravelDate = new DateTime(2025, 8, 29, 6, 0, 40, 298, DateTimeKind.Utc).AddTicks(8269)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            ToPlace = "Pune",
                            TotalSeats = 30,
                            TravelDate = new DateTime(2025, 8, 31, 6, 0, 40, 298, DateTimeKind.Utc).AddTicks(8280)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            ToPlace = "Jaipur",
                            TotalSeats = 45,
                            TravelDate = new DateTime(2025, 8, 28, 6, 0, 40, 298, DateTimeKind.Utc).AddTicks(8285)
                        });
                });

            modelBuilder.Entity("BusServices.Models.BusImage", b =>
                {
                    b.HasOne("BusServices.Models.Event", "Event")
                        .WithMany("Images")
